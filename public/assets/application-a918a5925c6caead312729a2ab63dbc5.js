...
(function() {
  var adjustStyles, checkPasswordInput, removeEmptyFlaggedItemMsgs;
  ...
  $(function() {
    ...
    checkPasswordInput();
    return $("#user_password").keyup(checkPasswordInput);
  });

  adjustStyles = function() {
    var ul_navbar_links, window_width;
    ...
    if (window_width >= 747) {
      ...
      return $(".post-voting a").addClass("btn-lg");
    } else {
      return ul_navbar_links.addClass("navbar-default");
    }
  };

  removeEmptyFlaggedItemMsgs = function() {
    return $('.flagged-item-msg').each(function() {
  ...
  checkPasswordInput = function() {
    ...
    if (password.val()) {
      return password_confirm.prop("disabled", false);
    } else {
      password_confirm.val(null);
      return password_confirm.prop("disabled", true);
    }
  };
