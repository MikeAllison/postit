...
* Slug problems
You can create a user that has a username/slug of mike 2 (or mike.2)/mike-2 but then also have a user create a
username/slug of mike-2/mike-2...Ideally, you shouldn't be able to create a username if there is a user
whose username converts to the same slug.
